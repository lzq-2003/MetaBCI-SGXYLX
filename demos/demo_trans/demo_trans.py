...
if __name__ == '__main__':
    ...
    for i in range(1, 2):  # (5,6)代表第5次    训练次数
        ...
        for ele in dir_name:
            ...
            raw = mne.io.read_raw_bdf(os.path.join(filename1), preload=True,
                                      exclude=(['Fpz', 'Fp1', 'Fp2', 'AF7', 'AF8',
                                                'F7', 'F8',
                                                'FT7', 'FT8',
                                                'T7', 'T8',
                                                'TP7', 'TP8',
                                                'P7', 'P8',
                                                'PO7', 'PO8',
                                                'Oz', 'O1', 'O2', 'ECG', 'HEOR', 'HEOL', 'VEOU',
                                                'VEOL']))  # 读取文件中的脑电数据,,exclude=(['ECG','HEOR','HEOL','VEOU','VEOL'])
