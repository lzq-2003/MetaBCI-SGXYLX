...
import pandas as pd
from metabci.brainda.algorithms.smooth_filter.Smooth import smoother
'''
# =============================================================================
# 创建MNE.raw数据格式的info
# =============================================================================
...
class OnlineMI:
    ...
    def classify(self):
        ...
        model = joblib.load(r"D:\LZQ\《天津大学》\metaBCI创新应用开发赛\GitHub\demos\demo_system\示例校准数据\XC.pkl") # 导入模型
        # 设置循环，一次分类后接着下一次
        while True:
